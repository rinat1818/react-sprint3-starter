...
export function NoteEdit({ onSaveNote }) {
    ...
    function handleChange({ target }) {
        ...
        setNote(prev => ({
            ...
            info: {
                ...prev.info,
                ...(prev.type === 'NoteImg' ? { title: value } : { txt: value })  
            }
        }))
    }
    function showBtn() {
                ...
                <div className="note-container "
                    ...
                    <div className='input-title none'>
                        <input
                            ...
                            placeholder="Title"
                            style={{ backgroundColor: note.style.backgroundColor }}
                            onChange={({ target }) => setNote(prev => ({
                                ...prev,
                                info: { ...prev.info, noteTitle: target.value }  
                            }))}
                    ...
                    >
                        ...
                        <button 
                         ...
                         type="button" onClick={() => document.getElementById('img-upload').click()}
                            style={{ backgroundColor: note.style.backgroundColor }} >
                        ...
                        <button style={{ backgroundColor: note.style.backgroundColor }} onClick={hideGallery} className="save">Close</button>
